    ...
    <nav class="white">
     <div class="nav-wrapper container white">
      ...
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        <li><a href="source/login-home.php"><i class="material-icons makePink">account_circle</i></a></li>
        <li><a href="source/logout.php"><i class="material-icons makePink">power_settings_new</i></a></li>
      </ul>
      <ul class="side-nav" id="mobile-demo">
          <li><a class=" makePink text" href="source/login-home.php">My Account</a></li>
