...
if ($isDate1Valid == '0' and $isDate2Valid == '1' and $isDate3Valid == '1')   // only date1 is being used    
{
    ...
    $msyqlStatment = "INSERT INTO pigpens (pen, notch , tag, breed, date1, boar1, boar2, heat, line, newPen, comm, email) VALUES ('$pen','$notch','$tag', '$breed','$date1', '$boar1', '$boar2', '$heat', '$line', '$newPen', '$comm', '$email')";
...
else if ($isDate1Valid == '1' and $isDate2Valid == '0' and $isDate3Valid == '1')  // only date2 is being used
{
    ...
    $msyqlStatment = "INSERT INTO pigpens (pen, notch, tag, breed, boar1,date2, boar2, heat, line, newPen, comm, email) VALUES ('$pen', '$notch', '$tag', '$breed', '$boar1','$date2', '$boar2','$heat', '$line', '$newPen', '$comm', '$email')";
}
...
else if ($isDate1Valid == '1' and $isDate2Valid == '1' and $isDate3Valid == '0')   // only date3 is being used
{
    ...
    $msyqlStatment = "INSERT INTO pigpens (pen, notch, tag, breed, boar1, boar2, heat, date3, line, newPen, comm, email) VALUES ('$pen','$notch','$tag','$breed','$boar1','$boar2', '$heat','$date3','$line','$newPen','$comm', '$email')";
}
...
else if ($isDate1Valid == '0' and $isDate2Valid == '0' and $isDate3Valid == '1')   // only date1 and date2 are being used
{
    ...
    $msyqlStatment = "INSERT INTO pigpens (pen, notch, tag, breed, date1, boar1, date2, boar2, heat, line, newPen, comm, email) VALUES ('$pen', '$notch', '$tag', '$breed', '$date1', '$boar1', '$date2', '$boar2', '$heat', '$line', '$newPen', '$comm', '$email')";
}
...
else if ($isDate1Valid == '1' and $isDate2Valid == '0' and $isDate3Valid == '0')   // only date2 and date3 are being used
{
    ...
    $msyqlStatment = "INSERT INTO pigpens (pen, notch, tag, breed, boar1, date2, boar2, heat, date3, line, newPen, comm, email) VALUES ('$pen', '$notch', '$tag',  '$breed', '$boar1', '$date2', '$boar2', '$heat', '$date3', '$line', '$newPen','$comm', '$email')";
}
...
else if ($isDate1Valid == '0' and $isDate2Valid == '1' and $isDate3Valid == '0')  // only date1 and date3 are being used
{
    ...
    $msyqlStatment = "INSERT INTO pigpens (pen, notch, tag, breed, date1, boar1, boar2, heat, date3, line, newPen, comm, email) VALUES ('$pen', '$notch','$tag', '$breed','$date1','$boar1','$boar2','$heat','$date3','$line','$newPen','$comm', '$email')";
}
...
else if ($isDate1Valid == '0' and $isDate2Valid == '0' and $isDate3Valid == '0') // all date fields are filled
{
    ...
    $msyqlStatment = "INSERT INTO pigpens (pen, notch, tag, breed, date1, boar1, date2, boar2, heat, date3, line, newPen, comm, email) VALUES ('$pen','$notch','$tag','$breed','$date1','$boar1','$date2', '$boar2','$heat','$date3','$line','$newPen','$comm', '$email')";
}

else if ($isDate1Valid == '1' and $isDate2Valid == '1' and $isDate3Valid == '1') // no date fields are filled
{
     $msyqlStatment = "INSERT INTO pigpens (pen, notch, tag, breed, boar1, boar2, heat, line, newPen, comm, email) VALUES ('$pen','$notch','$tag','$breed','$boar1','$boar2','$heat','$line','$newPen','$comm', '$email')";
}
